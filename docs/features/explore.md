...
[![some data request on Navitia playground](/img/playground_pt_ref.png)](https://playground.navitia.io/play.html?request=https%3A%2F%2Fapi.navitia.io%2Fv1%2Fcoverage%2Fsandbox%2Flines&token=3b036afe-0110-4202-b9ed-99718476c2e0)
...
-   **[Public transportation objects](/api/public-transport-objects)**: List of the public transport
    objects of a region
-   **[Places](/api/autocomplete-places)** and **[PT_objects](/api/autocomplete-pt-objects)**: Search for data using autocomplete input.
