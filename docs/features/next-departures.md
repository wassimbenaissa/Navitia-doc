---
title: "Next departures and arrivals"
sidebar_position: 2
---
...
![stop_vs_terminus_schedules](/img/stop_vs_terminus_schedules.png)
...
-   **[Public transportation objects](/api/public-transport-objects)**: List of the public transport
    objects of a region
-   **[Stop Schedules](/api/stop-schedules)**, **[Terminus Schedules](/api/terminus-schedules)**, **[Departures](/api/departures)** and **[Arrivals](/api/arrivals)**:
