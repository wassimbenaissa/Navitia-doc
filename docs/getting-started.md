...
Have a look at the [examples below](/examples) to learn what services we provide and how to use them.
...
```
Go to the API [https://api.navitia.io](https://api.navitia.io)
...
![Put token in Firefox browser](/img/firefox_token.png)
...
![Try Navitia playgroung](/img/navitia_playground.png)


## About the data {#about-data}

The street network is extracted from [OpenStreetMap](https://www.openstreetmap.org). The public transport data are provided by networks that provide their timetables as open data. Some data improvements are achieved by Hove based on [https://transport.data.gouv.fr/](https://transport.data.gouv.fr/).
...
[https://github.com/hove-io/navitia/issues](https://github.com/hove-io/navitia/issues).
