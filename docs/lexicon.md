...
## Introduction {#lexicon-introduction}
...
[https://github.com/OpenTransport/vocabulary/blob/master/vocabulary.md](https://github.com/OpenTransport/vocabulary/blob/master/vocabulary.md)

You will often read "PT" in this document. PT stands for public transport.

## Stop Point {#lexicon-stop-point}
...
## Journey Pattern {#lexicon-journey-pattern}
